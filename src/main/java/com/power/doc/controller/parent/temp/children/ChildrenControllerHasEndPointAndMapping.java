...
/**
 * 测试子类继承父类 之 子类,类带 @RestController,会生成接口文档
 *
 * @author linwumingshi
 ...
 */
@RestController
@RequestMapping("/children/controller/hasEndPoint")
public class ChildrenControllerHasEndPointAndMapping extends ParentProjectController {
