 ...
 */
@RestController
@RequestMapping("/query/parameters/required")
public class QueryParameterRequiredUseCase {


	/**
	 * Use @required(Not Recommend)
	 * @apiNote 可以在成员属性上添加@required注解表明参数必填，不推荐使用,查看链接
	 * <a href="https://smart-doc-group.github.io/#/zh-cn/start/javadoc?id=_22-required%e4%bd%bf%e7%94%a8%e4%b8%8d%e6%8e%a8%e8%8d%90">@required</a>
	 * @param foo 测试对象
	 */
	@GetMapping("/use-required-set")
	public void foo(FooRequired foo) {
	}
	...
	public void bar(BarJsr303 barJsr303) {
	}


	/**
	 * Use @RequestParam(required = false) As Optional Param
	 * @apiNote 可以使用@RequestParam(required=false)来声明请求参数为可选项
	 * @param fooStr 测试字符串
	 * @param barStr 测试字符串
	 */
	@GetMapping("use-request-param-required/")
	public void koo(@RequestParam(required = false) String fooStr,@RequestParam String barStr){
